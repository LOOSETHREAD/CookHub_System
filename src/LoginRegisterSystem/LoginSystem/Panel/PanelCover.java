...
public class PanelCover extends javax.swing.JPanel {
    ...
    private ButtonOutLine exitButton;
    private boolean isLogin;
    
    public PanelCover() {
        initComponents();
        setOpaque(false);
        layout = new MigLayout("wrap, fill","[center]", "push[]10[]25[]10[]25[]10[]10[]push");
        setLayout(layout);
        init();
    }
    public void init(){
        ...
        button.setText("Already have an acount");
        ...
        exitButton = new ButtonOutLine();
        exitButton.setBackground(new Color(245,245,245));
        exitButton.setForeground(new Color(245,245,245));
